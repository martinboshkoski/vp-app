...
module.exports = function(connect) {
  ...
  const MongoDBStore = function(options, callback) {
    ...
    const vpDB = 'mongodb+srv://martinboshkoski:Mart1n990@cluster0.o8vyshm.mongodb.net/?retryWrites=true&w=majority/vp-clients'
    
    const connOptions = options.connectionOptions;
    mongodb.MongoClient.connect(vpDB, connOptions, function(error, client) {
      if (error) {
